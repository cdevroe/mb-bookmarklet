javascript: (function (){
    ...
    var w = window,
        ...
        if ( s.length > 0 ) { // There is a selection
            u = 'https://micro.blog/post?text=>%20' + encodeURIComponent(s) + encodeURIComponent('&#13;&#13;') + 'Source:%20[' + encodeURIComponent(d.title) + '](' + encodeURIComponent(w.location.href) + ')';
        } else {
            u = 'https://micro.blog/post?text=[' + encodeURIComponent(d.title) + '](' + encodeURIComponent(w.location.href) + ')';
        }
